       ...
       <div class="row">
         ...
         <div class="main col-8">
            ...
            <a href="javascript:void(0)" class="nbpic">
             <img src="~static/outing.png" alt="">
           </a>
         <div class="info">
          <div class="title">旅行·在路上</div>
           <div class="it"><a href="javascript:void(0)">简书</a> 编·收录了16228篇文章 · 1022人关注</div>
         </div>
           <button class="btn-active">
           <span >专题主页 ></span></button>
           <button class="simpleMail">投稿</button>
        </div>
...
export default {
  ...
  mounted() {
    document.querySelector(".users li:nth-of-type(2)").className =
      "asideActive";
